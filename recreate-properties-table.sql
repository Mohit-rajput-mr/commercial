-- WARNING: This will DELETE ALL PROPERTIES DATA!
-- Only run this if you're okay with losing all existing properties

-- Step 1: Drop dependent objects first (foreign keys, indexes, etc.)
...
-- Step 2: Drop the properties table
DROP TABLE IF EXISTS properties CASCADE;

-- Step 3: Recreate the properties table with correct constraint
...
-- Step 5: Recreate full-text search trigger
...
-- Step 6: Recreate updated_at trigger
...
-- Step 10: Verify the table was created correctly
SELECT 
    column_name,
    data_type,
    column_default,
