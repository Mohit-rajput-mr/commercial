...
-- This handles orphaned records BEFORE dropping the table

-- Step 1: Delete orphaned records from related tables FIRST
-- (Records that reference properties that will be deleted)
...
-- Step 11: Verify
SELECT 'Properties table recreated successfully!' as status;
SELECT 
